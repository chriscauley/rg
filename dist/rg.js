(function (global, factory) {
   ...
   */
   ...
   riot$1.tag2('rg-bubble', '<div class="{css[opts.bubble.direction]}" if="{isvisible}" style="min-width: 100%"> <div class="{css.arrow}"></div> <div class="{css.inner}">{opts.bubble.text}</div> </div> <div class="content" onmouseover="{showBubble}" onmouseout="{hideBubble}" onclick="{toggleBubble}"> <yield></yield> </div>', 'rg-bubble,rg-bubble [data-is="rg-bubble"],[data-is="rg-bubble"] [data-is="rg-bubble"]{ display: inline-block; position: relative; }', 'class="{css.outer}"', function(opts) {
   		this.mixin("CSSMixin");
